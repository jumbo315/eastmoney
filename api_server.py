...
from src.storage.db import (
    ...
    get_portfolio_dip_plans, get_dip_plan_by_id, create_dip_plan, update_dip_plan,
    delete_dip_plan, execute_dip_plan, get_pending_dip_plans,
...
@app.get("/api/portfolios/{portfolio_id}/dip-plans")
...
@app.post("/api/portfolios/{portfolio_id}/dip-plans")
...
@app.get("/api/portfolios/{portfolio_id}/dip-plans/{plan_id}")
...
@app.put("/api/portfolios/{portfolio_id}/dip-plans/{plan_id}")
...
@app.delete("/api/portfolios/{portfolio_id}/dip-plans/{plan_id}")
...
@app.post("/api/portfolios/{portfolio_id}/dip-plans/{plan_id}/execute")
    ...
    try:
        ...
        if not price:
            ...
            if plan['asset_type'] == 'fund':
                nav_history = await loop.run_in_executor(None, _get_fund_nav_history, plan['asset_code'], 5)
                if nav_history:
